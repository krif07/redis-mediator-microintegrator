...
public class RedisClassMediator extends AbstractMediator {
	...
	public boolean mediate(MessageContext messageContext) {
        ...
        try {
            ...
            if (registryInstance != null) {
                ...
                String redisTimeoutString = (String) messageContext.getProperty(RedisClassMediatorConstants.REDIS_SERVER_TIMEOUT);
                ...
                String redisPasswordString = (String) messageContext.getProperty(RedisClassMediatorConstants.REDIS_SERVER_PASSWORD);
                ...
                String redisDatabaseString = (String) messageContext.getProperty(RedisClassMediatorConstants.REDIS_SERVER_DATABASE);
                ...
                // Remove if any previously set attributes from the connector before executing again.                
                if (pros != null) {
	...
	private JedisPoolConfig buildPoolConfig() {
        ...
        String numTestsPerEvictionRunString = getRegistryResourceString(
        		RedisClassMediatorConstants.REG_PREFIX + RedisClassMediatorConstants.REDIS_SERVER_NUM_TESTS_PER_EVCT_RUN);
